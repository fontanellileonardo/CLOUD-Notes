...
Questa separazione abilita una funzione di "accoppiamento allentato" (\textit{loose coupling}) che consente di collegare e scollegare i servizi specifici da un'applicazione senza sforzo
